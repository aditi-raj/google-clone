This project is a simple clone of the Google homepage, built using HTML, CSS, and JavaScript. The purpose of this project is to practice and showcase my web development skills.
